 ...
 *       &lt;sequence>
 *         &lt;element name="id" type="{urn:hl7-org:v3}II.Lite" maxOccurs="unbounded" minOccurs="0" form="qualified"/>
 *         &lt;element name="effectiveTime" type="{urn:hl7-org:v3}TS.Lite" minOccurs="0" form="qualified"/>
 *         &lt;element name="patientContext" type="{urn:hl7-org:v3}REDS_MT010001UV.PatientContext" minOccurs="0" form="qualified"/>
 *         &lt;element name="holder" type="{urn:hl7-org:v3}REDS_MT010001UV.Holder" minOccurs="0" form="qualified"/>
 *         &lt;element name="performer" type="{urn:hl7-org:v3}REDS_MT010001UV.Performer" minOccurs="0" form="qualified"/>
 *         &lt;element name="informationRecipient" type="{urn:hl7-org:v3}REDS_MT010001UV.InformationRecipient" minOccurs="0" form="qualified"/>
 *         &lt;element name="taskContext" type="{urn:hl7-org:v3}REDS_MT010001UV.TaskContext" form="qualified"/>
 *         &lt;element name="subTopic" type="{urn:hl7-org:v3}REDS_MT010001UV.SubTopic" minOccurs="0" form="qualified"/>
 *         &lt;element name="mainSearchCriteria" type="{urn:hl7-org:v3}REDS_MT010001UV.MainSearchCriteria" form="qualified"/>
 *         &lt;element name="encounter" type="{urn:hl7-org:v3}REDS_MT010001UV.Encounter" minOccurs="0" form="qualified"/>
...
public class REDSMT010001UVKnowledgeRequestNotification {
    ...
    @XmlElementRef(name = "patientContext", namespace = "urn:hl7-org:v3", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "informationRecipient", namespace = "urn:hl7-org:v3", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "subTopic", namespace = "urn:hl7-org:v3", type = JAXBElement.class)
