 ...
 *       &lt;choice>
 *         &lt;element name="healthCareProvider" type="{urn:hl7-org:v3}REDS_MT010001UV.HealthCareProvider" form="qualified"/>
 *         &lt;element name="patient" type="{urn:hl7-org:v3}REDS_MT010001UV.Patient" form="qualified"/>
 *       &lt;/choice>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class REDSMT010001UVInformationRecipient {
    ...
    @XmlElementRef(name = "healthCareProvider", namespace = "urn:hl7-org:v3", type = JAXBElement.class)
