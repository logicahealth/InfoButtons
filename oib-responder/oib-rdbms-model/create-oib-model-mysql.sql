...
-- --------------------------------------------------------------------
INSERT INTO OIB_CONCEPT (CONCEPT_ID, CODE, CODE_SYSTEM, CODE_SYSTEM_DISPLAY_NAME, DISPLAY_NAME)
SELECT OIB.NEXTVAL('ID_SEQ'), B.CODE, B.CODE_SYSTEM_OID, NULL, B.CODE_DISPLAY_NAME
FROM (
