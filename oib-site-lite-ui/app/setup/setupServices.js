...
oibSetupServices.service('umlsModal', function ($uibModal, propertiesService) {
    ...
    var oibPropertiesUrl = 'http://' + localStorage.getItem('hostName') + '/infobutton-service/propertiesManager/'
...
oibSetupServices.service('propertiesService', function ($rootScope, $http) {
    ...
    var oibPropertiesService = 'http://' + localStorage.getItem('hostName') + '/infobutton-service/propertiesManager/'
