...
oibSetupServices.service('umlsModal', function ($uibModal, propertiesService) {
    ...
    var oibPropertiesUrl = 'https://' + localStorage.getItem('hostName') + '/infobutton-service/propertiesManager/'
...
oibSetupServices.service('propertiesService', function ($rootScope, $http) {
    ...
    var oibPropertiesService = 'https://' + localStorage.getItem('hostName') + '/infobutton-service/propertiesManager/'
