...
oibAssetControllerModule.controller('EditModalCtrl', ['$scope', '$state', 'selectedProperty', 'assetId', 'assetFactory', 'ngNotify', '$filter', function ($scope, $state, selectedProperty, assetId, assetFactory, ngNotify, $filter) {
    ...
    var taskCodes = [{"displayName" : "allergy list entry", "code" : "ALLERLE", "id": "15c"},
                        ...
                        {"displayName" : "gene sequence panel review" , "code" : "GENEREV", "id" : "36c"},
                        ...
                        {"displayName" : "order entry", "code" : "OE", "id": "1c"},
                        ...
                        {"displayName" : "Variant results review" , "code" : "VARREV", "id" : "37c"},
