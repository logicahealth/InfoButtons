...
public interface ExternalResourceHandler
{
    ...
    /**
     * Retrieves a set of candidate codes from a set of code systems that approximately match a given term. The search
     * can be restricted to a subTree in a terminology (e.g., clinical findings in SNOMED-CT). For now, the UTS
     * implementation searches only in SNOMEDCT,ICD10CM and ICD9CM code systems
     * 
